...
<section class="hero relative bg-cover bg-center bg-no-repeat h-72 flex items-center">
  ...
  <div class="container mx-auto text-center z-10">
    ...
    <form class="block mx-5 md:mx-auto md:space-x-2">
      <input type="text" name="keywords" placeholder="Keywords" class="w-full md:w-72 px-4 py-3 focus:outline-none bg-gray-50"/>
      <input type="text" name="location" placeholder="Location" class="w-full md:w-72 px-4 py-3 focus:outline-none bg-gray-50"/>
